               ...
               <v-card-actions class="py-0">
                  <v-list-item class="grow">
                      ...
                      >
                          ...
                          <NewsDialog :news_id="news.id" @news_deleted="news_update($event)" @news_delete_failed="news_delete_failed($event)" />
                      </v-row>
...
import NewsDialog from "./admin_components/news_dialog"
export default {
   data: () => ({
      moment: moment,
      news: [],
