         ...
         <v-row class="mx-1 py-2 mt-n2 mb-2">
            <v-col cols="12">
               <v-card min-height="450" class="mx-4 pb-4" elevation="10">
                  <v-card-text class="text-subtitle-1 mt-1 pb-0 orange--text text--darken-3"> EVENT NAME: </v-card-text>
                  <v-card-title class="text-h6 mb-1 pt-0">
                     {{ single_event.event_name }}
                  </v-card-title>

                  <v-card-text class="text-subtitle-2 mt-n3 pb-0 orange--text text--darken-3"> EVENT TYPE: </v-card-text>
                  ...
                  <v-card-subtitle class="text-subtitle-1 orange--text text--darken-3">
                     Event Date: {{ moment(single_event.event_date).format('MMMM Do YYYY, h:mm a') }}
                  </v-card-subtitle>
